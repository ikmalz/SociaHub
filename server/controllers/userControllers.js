...
export const discoverUsers = async (req, res) => {
  try {
    ...
    const filteredUsers = allUsers.filter((user) => user._id);
...
export const sendConnectionRequest = async (req, res) => {
  try {
    ...
    // Check if user has sent more than 20 connection requests in the las 24 hours
    ...
    if (connectionRequests.length >= 20) {
      return res.json({
        success: false,
        message:
          "You have sent more than 20 connection requests in the las 24 hours",
      });
    }
